...
namespace HangManStarterKit
{
    class HangmanGame
    {
        //this is the word you are trying to guess
        public string word;
        public int tries = 0;//this ticks up each time we guess in the other method
        public List<char> guessedLetters = new List<char>();
        public List<char> foundLetters = new List<char>();
        List<string> wordBank = new List<string>{"apple", "tree", "dog", "rides", "scrambled", "fish" };
        Player guesser;
        public HangmanGame(Player guesser)//first constructor
        {
        ...
        public void PlayRound(char guess)
        {
            ...
            else if (word.Contains(guess))
            {
                ...
                while (temp.IndexOf(guess) != -1)
                {
                    ...
                    foundLetters[index + FirstIndex] = guess;

                    FirstIndex = index + FirstIndex + 1;
